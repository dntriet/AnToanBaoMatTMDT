<?php
    ...
    try {
        ...
        if ($verifyRefreshToken->status == 'success') {
            $jsonEncodeRefreshToken = json_encode($verifyRefreshToken);
            echo $jsonEncodeRefreshToken->user_id;
            $user_id = $jsonEncodeRefreshToken->user_id;
            $role_id = $jsonEncodeRefreshToken->role_id;
